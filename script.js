...
/* Verbetes iniciais (base). Você pode expandir muito depois sem mexer no layout. */
const ENTRIES = [
  {
    id:"major-scale", category:"scales",
    ...
    bullets:{
      pt:["Define o campo harmônico diatônico (I, ii, iii, IV, V, vi, vii°).","Base para melodias e progressões tonais.","Relativa menor compartilha a mesma armadura."],
      en:["Defines diatonic harmony (I, ii, iii, IV, V, vi, vii°).","Foundation for tonal melodies and progressions.","Relative minor shares the same key signature."],
      es:["Define la armonía diatónica (I, ii, iii, IV, V, vi, vii°).","Base para melodías y progresiones tonales.","La relativa menor comparte armadura."]
    },
    examples:{
    ...
    aliases:["escala maior","major scale","escala mayor","WWHWWWH","TTSTTT S".replace(" ","")],
    seeAlso:["natural-minor","modes","diatonic-triads"],
    imageUrl:""
  },

  {
    id:"natural-minor", category:"scales",
    title:{pt:"Escala Menor Natural", en:"Natural Minor Scale", es:"Escala Menor Natural"},
    short:{
      pt:"Modo eólio: T–S–T–T–S–T–T. Base do ‘menor’ sem alterações.",
      en:"Aeolian mode: W–H–W–W–H–W–W. Minor without alterations.",
      es:"Modo eólico: T–S–T–T–S–T–T. Menor sin alteraciones."
    },
    definition:{
  ...
  {
    id:"modes", category:"scales",
    title:{pt:"Modos Gregos", en:"Greek Modes", es:"Modos Griegos"},
    short:{
      pt:"Mesmas notas, centro tonal diferente: Jônio, Dório, Frígio, etc.",
      en:"Same notes, different tonal center: Ionian, Dorian, Phrygian, etc.",
      es:"Mismas notas, centro tonal diferente: Jónico, Dórico, Frigio, etc."
    },
    definition:{
      pt:"<b>Modos</b> são ‘variações’ de uma escala quando você muda a nota que funciona como <b>centro</b>. Isso altera o caráter (cor) sem mudar o conjunto de notas. Em música modal, o centro e notas características precisam ser enfatizados.",
      en:"<b>Modes</b> are ‘views’ of a scale when you change the <b>tonal center</b>. The note set stays the same, but the color changes. In modal music, emphasize the center and characteristic tones.",
      es:"Los <b>modos</b> son ‘vistas’ de una escala al cambiar el <b>centro tonal</b>. El conjunto de notas no cambia, pero el color sí. En música modal, enfatiza centro y notas características."
    },
    bullets:{
      pt:["Jônio = maior; Eólio = menor natural.","Dórico tem 6º maior; Mixolídio tem 7º menor.","Muito usados em jazz, rock e trilhas."],
      en:["Ionian = major; Aeolian = natural minor.","Dorian has natural 6; Mixolydian has flat 7.","Common in jazz, rock and film scoring."],
      es:["Jónico = mayor; Eólico = menor natural.","Dórico tiene 6 natural; Mixolidio tiene 7 bemol.","Comunes en jazz, rock y bandas sonoras."]
    },
    examples:{
      pt:"Em Dó maior: <b>Ré dórico</b> usa as mesmas notas, mas ‘casa’ em Ré.",
      en:"In C major: <b>D Dorian</b> uses the same notes but ‘homes’ on D.",
      es:"En Do mayor: <b>Re dórico</b> usa las mismas notas pero ‘cierra’ en Re."
    },
  ...
  {
    id:"perfect-fifth", category:"intervals",
    title:{pt:"Quinta Justa", en:"Perfect Fifth", es:"Quinta Justa"},
    short:{
      pt:"Intervalo estável e consonante. Base de acordes e do círculo de quintas.",
      en:"Stable consonant interval. Core of chords and the circle of fifths.",
      es:"Intervalo estable consonante. Base de acordes y círculo de quintas."
    },
    definition:{
      pt:"A <b>quinta justa</b> é o intervalo entre a nota e seu 5º grau (ex.: Dó→Sol). É um dos intervalos mais consonantes e aparece em tríades, power chords e na organização tonal.",
      en:"A <b>perfect fifth</b> spans root to the 5th degree (e.g., C→G). It’s highly consonant and appears in triads, power chords, and tonal organization.",
      es:"La <b>quinta justa</b> va de la nota al 5º grado (p. ej., Do→Sol). Es muy consonante y aparece en tríadas, power chords y organización tonal."
    },
    bullets:{
  ...
  {
    id:"syncopation", category:"rhythm",
    ...
    definition:{
      ...
      en:"<b>Syncopation</b> happens when accents land in less expected places (offbeats/weak subdivisions). It can be created by anticipations, delays, ties and strategic rests.",
    ...
    bullets:{
      pt:["Muito comum em samba, funk, jazz e pop.","Ajuda a criar swing e sensação de movimento.","Depende de subdivisão clara para soar preciso."],
      en:["Common in samba, funk, jazz and pop.","Creates swing and forward motion.","Requires clear subdivision to feel tight."],
    ...
    aliases:["síncope","syncopation","síncopa","contratempo","offbeat"],
    seeAlso:["meter","subdivision"],
    imageUrl:""
  },

  {
    id:"key-signature", category:"notation",
    ...
    definition:{
      pt:"A <b>armadura de clave</b> aparece após a clave e indica quais notas serão alteradas ao longo do trecho (sustenidos/bemóis). Ela reduz acidentes repetidos e aponta a tonalidade (maior ou relativa menor).",
  ...
  {
    id:"diatonic-triads", category:"harmony",
    ...
    aliases:["campo harmônico","diatonic triads","tríades diatônicas","tríadas diatónicas"],
    seeAlso:["major-scale","triad","dominant-function"],
    imageUrl:""
  },

  {
    id:"circle-of-fifths", category:"harmony",
    ...
    bullets:{
      pt:["Excelente para memorizar armaduras.","Ajuda em progressões comuns (ii–V–I).","Mostra tonalidades vizinhas rapidamente."],
      en:["Great for memorizing key signatures.","Helps common progressions (ii–V–I).","Shows neighboring keys quickly."],
      es:["Excelente para memorizar armaduras.","Ayuda en progresiones (ii–V–I).","Muestra tonalidades vecinas rápido."]
    },
    examples:{
  ...
  {
    id:"music-periods", category:"history",
    ...
    aliases:["períodos musicais","musical periods","barroco","clássico","romântico"],
    seeAlso:["circle-of-fifths"],
    imageUrl:""
  },

  /* termos ponte (pra busca ficar forte) */
  {
    id:"meter", category:"rhythm",
    title:{pt:"Compasso (Métrica)", en:"Meter (Time Signature)", es:"Compás (Métrica)"},
    short:{
      pt:"Organiza o pulso em grupos: 4/4, 3/4, 6/8...",
      en:"Groups beats: 4/4, 3/4, 6/8...",
      es:"Agrupa pulsos: 4/4, 3/4, 6/8..."
    },
    definition:{
  ...
  {
    id:"subdivision", category:"rhythm",
    title:{pt:"Subdivisão", en:"Subdivision", es:"Subdivisión"},
    short:{
      pt:"Divide o pulso em partes menores: binário, ternário (tercinas).",
      en:"Splits the beat: duple, triple (triplets).",
      es:"Divide el pulso: binario, ternario (tresillos)."
    },
    definition:{
...
function setYear(){
  ...
  if(a) a.textContent=y; if(b) b.textContent=y; if(c) c.textContent=y;
}

function langText(obj){
  return obj?.[currentLang] ?? obj?.pt ?? "";
}
function categoryName(key){ return langText(CATEGORIES[key] || {pt:key,en:key,es:key}); }
function categorySubtitle(key){ return langText(CATEGORY_SUB[key] || {pt:"",en:"",es:""}); }
...
function searchResults(){
  ...
  // ranking simples (título/aliases mais forte)
  hits.sort((a,b)=>{
    const at = normalize(langText(a.title));
    const bt = normalize(langText(b.title));
    const aScore = (at.includes(q)? 3:0) + ((a.aliases||[]).some(al=>normalize(al).includes(q))? 2:0);
    const bScore = (bt.includes(q)? 3:0) + ((b.aliases||[]).some(al=>normalize(al).includes(q))? 2:0);
    return bScore - aScore;
  });

  if(currentCategoryFilter !== "all"){
    return hits.filter(e=>e.category===currentCategoryFilter).map(e=>e.id);
  }
